...
def get_apprentice_count():
    ...
    min_apprentice_count = 10
    max_apprentice_count = 100
    prompt = "Entrer le nombre d'apprentis à générer : "
    error_message = "Choix invalide..."

    apprentice_count = to_valid_positive_integer(prompt, error_message, min_apprentice_count, max_apprentice_count)
