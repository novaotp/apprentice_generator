...
def get_apprentice_per_block():
    ...
    min_apprentice_per_block = 1
    max_apprentice_per_block = 20
    prompt = "Entrer le nombre d'apprentis par bloc : "
    error_message = "Choix invalide..."

    apprentice_per_block = to_valid_positive_integer(prompt, error_message, min_apprentice_per_block, max_apprentice_per_block)
